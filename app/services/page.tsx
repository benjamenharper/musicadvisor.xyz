          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-card rounded-lg p-8 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <Link 
                  href={`mailto:contact@musicadvisor.xyz?subject=Music Marketing Inquiry&body=I'm interested in your music marketing services. I would like to learn more about your services.`}
            ...
            <div className="bg-card rounded-lg p-8 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <Link 
                  href={`mailto:contact@musicadvisor.xyz?subject=Music Distribution Inquiry&body=I'm interested in your music distribution services. I would like to learn more about your services.`}
                  className="inline-block mt-4 px-6 py-3 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
                >
                  Start Distribution
                </Link>
